...
pub mod Windows {
    pub mod PluggablePasskeys {
        ...
        impl EXPERIMENTAL_IPluginAuthenticator_Vtbl {
            pub const fn new<
                Identity: EXPERIMENTAL_IPluginAuthenticator_Impl,
                const OFFSET: isize,
            >() -> Self {
                unsafe extern "system" fn EXPERIMENTAL_PluginMakeCredential<
                    Identity: EXPERIMENTAL_IPluginAuthenticator_Impl,
                    const OFFSET: isize,
                >(
                    this: *mut core::ffi::c_void,
                    request: *const _EXPERIMENTAL_WEBAUTHN_PLUGIN_OPERATION_REQUEST,
                    response: *mut *mut _EXPERIMENTAL_WEBAUTHN_PLUGIN_OPERATION_RESPONSE,
                ) -> windows_core::HRESULT {
                    unsafe {
                        let this: &Identity =
                            &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                        match EXPERIMENTAL_IPluginAuthenticator_Impl:: EXPERIMENTAL_PluginMakeCredential ( this , core::mem::transmute_copy ( & request ) , ) { Ok ( ok__ ) => { response . write ( core::mem::transmute ( ok__ ) ) ; windows_core::HRESULT ( 0 ) } Err ( err ) => err . into ( ) }
                    }
                }
                unsafe extern "system" fn EXPERIMENTAL_PluginGetAssertion<
                    Identity: EXPERIMENTAL_IPluginAuthenticator_Impl,
                    const OFFSET: isize,
                >(
                    this: *mut core::ffi::c_void,
                    ...
                    unsafe {
                        let this: &Identity =
                            &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                        match EXPERIMENTAL_IPluginAuthenticator_Impl:: EXPERIMENTAL_PluginGetAssertion ( this , core::mem::transmute_copy ( & request ) , ) { Ok ( ok__ ) => { response . write ( core::mem::transmute ( ok__ ) ) ; windows_core::HRESULT ( 0 ) } Err ( err ) => err . into ( ) }
                    }
                }
                unsafe extern "system" fn EXPERIMENTAL_PluginCancelOperation<
                    Identity: EXPERIMENTAL_IPluginAuthenticator_Impl,
                    const OFFSET: isize,
                >(
                    this: *mut core::ffi::c_void,
                    ...
                    unsafe {
                        let this: &Identity =
                            &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                        EXPERIMENTAL_IPluginAuthenticator_Impl::EXPERIMENTAL_PluginCancelOperation(
                            this,
                ...
                Self {
                    ...
                    EXPERIMENTAL_PluginMakeCredential: EXPERIMENTAL_PluginMakeCredential::<
                        Identity,
                        OFFSET,
                    >,
                    EXPERIMENTAL_PluginGetAssertion: EXPERIMENTAL_PluginGetAssertion::<
                        Identity,
                        OFFSET,
                    >,
                    EXPERIMENTAL_PluginCancelOperation: EXPERIMENTAL_PluginCancelOperation::<
                        Identity,
                        OFFSET,
                    >,
                }
        ...
        pub const WEBAUTHN_ATTESTATION_TYPE_PACKED: windows_core::PCWSTR =
            windows_core::w!("packed");
        pub const WEBAUTHN_ATTESTATION_TYPE_TPM: windows_core::PCWSTR = windows_core::w!("tpm");
        pub const WEBAUTHN_ATTESTATION_TYPE_U2F: windows_core::PCWSTR =
            windows_core::w!("fido-u2f");
        ...
        pub struct WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS {
            ...
            pub EXPERIMENTAL_cCredentialHints: u32,
            pub EXPERIMENTAL_ppwszCredentialHints: *const windows_core::PCWSTR,
            pub EXPERIMENTAL_bThirdPartyPayment: windows_core::BOOL,
        }
        ...
        pub const WEBAUTHN_CREDENTIAL_HINT_HYBRID: windows_core::PCWSTR =
            windows_core::w!("hybrid");
        ...
        pub const WEBAUTHN_HASH_ALGORITHM_SHA_256: windows_core::PCWSTR =
            windows_core::w!("SHA-256");
        pub const WEBAUTHN_HASH_ALGORITHM_SHA_384: windows_core::PCWSTR =
            windows_core::w!("SHA-384");
        pub const WEBAUTHN_HASH_ALGORITHM_SHA_512: windows_core::PCWSTR =
            windows_core::w!("SHA-512");
        #[repr(C)]
        #[derive(Clone, Copy, Debug, PartialEq)]
